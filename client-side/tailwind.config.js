    ...
    extend: {
      colors: {
				...
				"dark-blue-s": "rgb(10 132 255)",
				 'brand-orange': '#FF8C00', // Example: DarkOrange
        'brand-orange-s': '#FFA500', // Example: Lighter shade for hover
        'dark-layer-1': '#1e1e1e',
        'dark-layer-2': '#2c2c2c',
        'dark-fill-3': '#4a4a4a',
        'dark-divider-border-2': '#3a3a3a',
        'dark-gray-7': '#b3b3b3', // Example, adjust to your needs
			},
    },
  },
  plugins: [],
